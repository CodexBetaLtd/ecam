...
public class AssestEventAuditController {
	public static final String REQUEST_MAPPING_URL = "/asset-event-audit";
	@Autowired
	AssestEventAuditService assestEventAuditService;
	
	@RequestMapping(value = "/historybyAssestEventId/{assestEventId}", method = RequestMethod.GET)
